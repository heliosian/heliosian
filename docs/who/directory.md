...
- Self-service: viewing your own record, your household's (an adult edits the children and the other adults; a student edits only themselves, not their siblings or parents), or your family page shows inline edit affordances — photo upload, pronunciation recording or upload, About Me text, preferred name, phone, address — plus opt-out for yourself or your kids. A media upload adds an object and a row naming it, never replacing what was there; sheet-backed edits write the Overrides tab (person fields) or the Families tab (family fields) and append a Change Log row (see `docs/who/data.md`). A facts edit or photo upload also stamps that item's updated date.
