...
- **no CPU throttling** — every sheet and the blob store refresh together on one five-minute ticker between requests; default throttling would starve them.
