...
- `Change Log` - Timestamp, Actor, Action, Kind, Celebration, Party, Title, Email, Details, Real Actor; appended on every change, never read back. Real Actor is who was signed in when Actor is who the change was made as, the two differing under Spoof Mode (`docs/toolbar.md`).
