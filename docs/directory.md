...
- Refresh reminders: every page carries a band listing the signed-in user's own, their kids', and their family's content that has aged past its window — a photo past 0.75 years, an About Me past 0.6, a family photo past 1.5 — the cadence the previous app used. Each row links to that record's edit view, and an Update Family Info action leads to the family page. Only aged content is prompted: a record with no photo or no About Me raises nothing, and an item whose updated date is unknown counts as aged.
