...
import (
	...
	"heliosian/tools/internal/capture"
)
...
func sampleServer() (*http.Server, *directory.Queue) {
	...
	return app.Server(auth.Fixed(sampleUser, core.Gate)), core.Queue
}
