...
func TestSharePreview(t *testing.T) {
	...
	for _, path := range []string{"/", "/some/page"} {
		...
		for _, want := range []string{`og:site_name" content="Helios Who?"`, `og:title" content="Put a face to a name`, `og:url" content="https://who.heliosian.com/"`, `og:image" content="https://who.heliosian.com/open/share/about.png"`} {
