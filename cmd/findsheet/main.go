...
func main() {
	...
	for _, variable := range []string{"DIRECTORY_SHEET", "PREFERENCES_SHEET", "INVITES_SHEET", "APPS_SHEET", "EVENTS_SHEET", "BIRTHDAY_SHEET", "CALENDAR_SHEET", "CELEBRATE_SHEET", "CONFIG_SHEET"} {
