...
- Server-side requests to addresses a person supplied: the image import (that the three stock libraries are the whole of it, redirects included), link previews, anything that fetches what a sheet names.
